...
ActiveRecord::Schema.define(version: 2022_05_14_063815) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.boolean "notdisplay_flag", default: false, null: false
    t.string "image_url"
    t.string "image_url2"
    t.string "image_url3"
    t.string "image_url4"
    ...
    t.string "product_demension"
    t.string "item_weight"
    t.string "order_url"
    t.string "asin"
    t.string "item_model_number"
    t.boolean "stock_out_flag", default: false, null: false
  ...
  create_table "shopping_carts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "is_express", default: false, null: false
