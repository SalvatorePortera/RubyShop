...
      Category.create!(name: sweets_category,description: sweets_category,major_category_name: major_category_name)
    end
    
 elsif major_category_name == "神薬"
    drug_categories.each do |drug_category|
    Category.create!(name: drug_category,description: drug_category,major_category_name: major_category_name)
    end
    
 elsif major_category_name == "化粧品"
    cosmetic_categories.each do |cosmetic_category|
      Category.create!(name: cosmetic_category,description: cosmetic_category,major_category_name: major_category_name)
    end
    
 elsif major_category_name == "魔法瓶・炊飯器・時計・スーツケース"
    thermos_categories.each do |thermos_category|
      Category.create!(name: thermos_category,description: thermos_category,major_category_name: major_category_name)
    end
 
 elsif major_category_name == "家電・カメラ"
  electric_categories.each do |electric_category|
   Category.create!(name: electric_category,description: electric_category,major_category_name: major_category_name)
  end

 elsif major_category_name == "万年筆・文房具・雑貨"
  stationary_categories.each do |stationary_category|
   Category.create!(name: stationary_category,description: stationary_category,major_category_name: major_category_name)
  end
   
 elsif major_category_name == "伝統工芸品・富士山・桜"
  gift_categories.each do |gift_category|
   Category.create!(name: gift_category,description: gift_category,major_category_name: major_category_name)
  end
   
 elsif major_category_name == "贈る相手別"
  vip_categories.each do |vip_category|
   Category.create!(name: vip_category,description: vip_category,major_category_name: major_category_name)
  end
   
 elsif major_category_name == "ゲーム・アニメ"
  game_categories.each do |game_category|
   Category.create!(name: game_category,description: game_category,major_category_name: major_category_name)
  end   
